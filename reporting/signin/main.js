...
function listMajors() {
    ...
    gapi.client.sheets.spreadsheets.values.get({
        spreadsheetId: '1DmOFAR2BAZKwMdIgGBtlh1iZplnkQIGhEMKxp9nDeNY',
        range: "A1:Z100",
...
function use_table(email) {
    ...
    gapi.client.sheets.spreadsheets.values.get({
        ...
        object[object.length] = new Array(email, $('#name').val(), $('#phone').val(), $('#contacts').val(), $('#github').val(), $('#trello').val(), $('#money').val());
